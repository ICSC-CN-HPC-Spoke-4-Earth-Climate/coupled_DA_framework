...
!ANTO+
! set a threshold for maximum ice thickness to a realistic 7m
             if (hicen (n) > 7) then
                 hicen(n)=7
                 vicen(n)=hicen(n)*aicen(n)
!                 print*,"ANTO threshold to hicen"
!                 print*,"     reset to 7 for cat",n
!                 print*,"     vicen reset ",vicen(n)
!                 print*," "
             endif
!ANTO-
...
!ANTO+
!      if(hbnew(ncat)>7.) then
!         print*,"ANTO check hbnew > 7 ",hbnew(ncat)
!      endif
!ANTO-
