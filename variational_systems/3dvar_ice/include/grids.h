...
LOGICAL, PARAMETER :: LLMDT(NGRIDS) = (/.TRUE.,.TRUE.,.TRUE.,.TRUE.,.TRUE.,.TRUE.,.FALSE. /)
LOGICAL, PARAMETER :: LLMDTERR(NGRIDS) = (/.TRUE.,.TRUE.,.TRUE.,.TRUE.,.TRUE.,.TRUE.,.FALSE. /)

!... Grid identification names
CHARACTER(LEN=50), PARAMETER :: CNGRID(NGRIDS) = &
(/ 'GLO05L31 ', 'GLO05L50 ', 'GLO2L31  ', 'GLO025L50', 'GLO116L98', 'BS2736L31', 'GLO1' /)
