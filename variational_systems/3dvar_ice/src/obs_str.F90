...
INTEGER , PARAMETER ::   NPRD_SLA = NPRDS, NPRD_SST = NPRDS, NPRD_SSS = NPRDS,NPRD_SIC=NPRDS, NPRD_SIT=NPRDS
INTEGER , PARAMETER ::   NPQ=4
LOGICAL, SAVE :: LL_SLAAD_INIT = .FALSE.
LOGICAL, SAVE :: LL_OBSGRAINIT = .FALSE.
...
! OBSERVATIONAL VECTOR IN THE COST FUNCTION
   TYPE OBS_T
        ...
        REAL(R8),    DYNMEM     ::  PERT(:)     ! OBSERVATIONAL GRADIENT
        REAL(R8),    DYNMEM     ::  AHUB(:,:)     ! HUBER-NORM CONSTANT
        REAL(R8),    DYNMEM     ::  AHUB2(:,:)     ! HUBER-NORM CONSTANT
        INTEGER(PREC_INT),DYNMEM::  NHUB(:)     ! HUBER-NORM SWITCH
        ...
        INTEGER(PREC_INT)              ::  AIR        ! FLAG FOR ASSIMILATION OF SATELLITE SSS OBS
        INTEGER(PREC_INT)              ::  SIC        ! FLAG FOR ASSIMILATION OF SIC
        INTEGER(PREC_INT)              ::  SIT        ! FLAG FOR ASSIMILATION OF SIT
   END TYPE OBS_T
...
! OBSERVATIONAL VECTOR FOR SLA
   TYPE SLA_T
        ...
        INTEGER(PREC_INT), DYNMEM     ::  TATS(:)
        INTEGER(PREC_INT), DYNMEM     ::  OBIN(:)
        ...
        REAL(DP),    DYNMEM     ::  TDIST(:)   ! TEMPORAL DISTANCE FROM ANALTIME
        REAL(R8),    DYNMEM     ::  LON(:)     ! LONGITUTE
        REAL(R8),    DYNMEM     ::  LAT(:)     ! LATITUDE
        REAL(DP),    DYNMEM     ::  TIM(:)     ! TIME
        ...
        !
        INTEGER(PREC_INT), DYNMEM     ::  IBH(:,:)      ! I INDEX OF THE NEAREST WEST POINT
        INTEGER(PREC_INT), DYNMEM     ::  JBH(:,:)      ! J INDEX OF THE NEAREST SOUTH POINT
        REAL(R8)   , DYNMEM     ::  PQH(:,:)     ! INTERPOLATION PARAMETER FOR MASKED GRIDS
...
! OBSERVATIONAL VECTOR FOR SST
   TYPE SST_T
        ...
        & LLREMSS_SWATH_TMI,LL_COPERN_L3S,LL_COPERN_L3,LL_METOPA_AVHRR,LL_AMSR2,LL_NOAA_OI
...
! OBSERVATIONAL VECTOR FOR SSS
   TYPE SSS_T
        LOGICAL :: LLAQUARIUS, LLSMOS, LLSACD
...
! ---
! OBSERVATIONAL VECTOR FOR SIC
   TYPE SIC_T
        LOGICAL :: LLOSISAF,LLHADISST
        INTEGER(I4) ::  ISICOBS(NOSICSATS)
        ! WHETHER TO USE AMSR-E, TMI, MWOI
        INTEGER(PREC_INT)              ::  NO         ! NUMBER OF ALL OBS
        INTEGER(PREC_INT)              ::  NC         ! NUMBER OF GOOD OBS
        INTEGER(PREC_INT), DYNMEM     :: TRACK(:)    ! TRACK NO
        ...
        REAL(R8),    DYNMEM     ::  VAL(:)     ! OBSERVED VALUE
        REAL(R8),    DYNMEM     ::  BAC(:)     ! BACKGROUND VALUE
        REAL(R8),    DYNMEM     ::  TRA_BAC(:)     ! TRANFORMED BACKGROUND VALUE
        REAL(R8),    DYNMEM     ::  INC(:)     ! INCREMENTS
        REAL(R8),    DYNMEM     ::  BIA(:)     ! BIAS
        REAL(R8),    DYNMEM     ::  ERR(:)     ! OBSERVATIONAL ERROR
        REAL(R8),    DYNMEM     ::  RES(:)     ! RESIDUAL
        ...
        INTEGER(PREC_INT), DYNMEM     ::  SD2(:)      ! I INDEX OF THE NEAREST WEST POINT
        INTEGER(PREC_INT), DYNMEM     ::  IBH(:,:)      ! I INDEX OF THE NEAREST WEST POINT
        INTEGER(PREC_INT), DYNMEM     ::  JBH(:,:)      ! J INDEX OF THE NEARESTSOUTH POINT
   END TYPE SIC_T
...
! OBSERVATIONAL VECTOR FOR SIC
   TYPE SIT_T
        LOGICAL :: LLESACRY2,LLSMOS,LLCRYOSMOSMERGED,LLPIOMAS,LLGIOMAS
        INTEGER(I4) ::  ISITOBS(NOSITSATS)
        ! WHETHER TO USE AMSR-E, TMI, MWOI
        INTEGER(PREC_INT)              ::  NO         ! NUMBER OF ALL OBS
        INTEGER(PREC_INT)              ::  NC         ! NUMBER OF GOOD OBS
        INTEGER(PREC_INT), DYNMEM     :: TRACK(:)    ! TRACK NO
        ...
        REAL(R8),    DYNMEM     ::  VAL(:)     ! OBSERVED VALUE
        REAL(R8),    DYNMEM     ::  BAC(:)     ! BACKGROUND VALUE
        REAL(R8),    DYNMEM     ::  TRA_BAC(:)     ! TRANSFORMED BACKGROUND VALUE
        REAL(R8),    DYNMEM     ::  INC(:)     ! INCREMENTS
        REAL(R8),    DYNMEM     ::  BIA(:)     ! BIAS
        REAL(R8),    DYNMEM     ::  ERR(:)     ! OBSERVATIONAL ERROR
        REAL(R8),    DYNMEM     ::  RES(:)     ! RESIDUAL
...
! OBSERVATIONAL VECTOR FOR TRAJECTORY
   TYPE TRJ_T
        ...
        REAL(DP)   , DYNMEM     ::  TIM(:)     ! TIME OF THE DURATION OF THE TRAJECTORY
