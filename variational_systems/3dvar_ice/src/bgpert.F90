...
IF ( LL_4DVAR .OR. LL_TLMODEL ) CALL TLMOD(1)
 ...
 IF( LL_SSH .AND. .NOT. LL_TQ2) THEN
  ...
  & GRD%SAL,GRD%TEM,.TRUE.,.FALSE.,.FALSE.,.FALSE.,SSH=GRD%ETA) 
ELSEIF( LL_TQ2 .AND. .NOT. LL_SSH ) THEN
  CALL WRANINC(GRD%IM,GRD%JM,GRD%KM,GRD%LON,GRD%LAT,GRD%DEP,&
  & GRD%SAL,GRD%TEM,.FALSE.,.TRUE.,.FALSE.,.FALSE.,T2M=GRD%T2M,Q2M=GRD%Q2M)
 ELSEIF( LL_TQ2 .AND. LL_SSH ) THEN
  CALL WRANINC(GRD%IM,GRD%JM,GRD%KM,GRD%LON,GRD%LAT,GRD%DEP,&
  & GRD%SAL,GRD%TEM,.TRUE.,.TRUE.,.FALSE.,.FALSE.,SSH=GRD%ETA,T2M=GRD%T2M,Q2M=GRD%Q2M)
 ELSE
  CALL WRANINC(GRD%IM,GRD%JM,GRD%KM,GRD%LON,GRD%LAT,GRD%DEP,&
  & GRD%SAL,GRD%TEM,.FALSE.,.FALSE.,.FALSE.,.FALSE.)
 ENDIF
 ...
 IF( LL_SSH .AND. .NOT. LL_TQ2) THEN
  CALL WRANINC(GRD%IM,GRD%JM,GRD%KM,GRD%LON,GRD%LAT,GRD%DEP,&
  & GRD%SAL,GRD%TEM,.TRUE.,.FALSE.,.TRUE.,.FALSE.,SSH=GRD%ETA,SIC=GRD%SIC,SIT=GRD%SIT,&
  & ICU=GRD%ICU, ICV=GRD%ICV)
 ELSEIF( LL_TQ2 .AND. .NOT. LL_SSH ) THEN
  CALL WRANINC(GRD%IM,GRD%JM,GRD%KM,GRD%LON,GRD%LAT,GRD%DEP,&
  & GRD%SAL,GRD%TEM,.FALSE.,.TRUE.,.TRUE.,.FALSE.,&
  & T2M=GRD%T2M,Q2M=GRD%Q2M,SIC=GRD%SIC,SIT=GRD%SIT,&
  & ICU=GRD%ICU, ICV=GRD%ICV)
 ELSEIF( LL_TQ2 .AND. LL_SSH ) THEN
  CALL WRANINC(GRD%IM,GRD%JM,GRD%KM,GRD%LON,GRD%LAT,GRD%DEP,&
  & GRD%SAL,GRD%TEM,.TRUE.,.TRUE.,.TRUE.,.FALSE.,SSH=GRD%ETA,&
  & T2M=GRD%T2M,Q2M=GRD%Q2M,SIC=GRD%SIC,SIT=GRD%SIT,&
  & ICU=GRD%ICU, ICV=GRD%ICV)
 ELSE
  CALL WRANINC(GRD%IM,GRD%JM,GRD%KM,GRD%LON,GRD%LAT,GRD%DEP,&
  & GRD%SAL,GRD%TEM,.FALSE.,.FALSE.,.TRUE.,.FALSE.,SIC=GRD%SIC,SIT=GRD%SIT,&
  & ICU=GRD%ICU, ICV=GRD%ICV)
 ENDIF
