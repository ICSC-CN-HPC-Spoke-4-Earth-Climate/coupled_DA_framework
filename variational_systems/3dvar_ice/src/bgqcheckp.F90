...
USE MYNETCDF
USE OBSHANDLING , ONLY : LLBGQC_SLA, LLBGQC_INS, LLBGQC_SST,LLBGQC_SIC,LLBGQC_SIT, RALFA_SLA, &
                       & RALFA_INS, RBGERR_SSH, RBGERR_SAL, &
                       & RBGERR_TEM ,RALFA_SST, RBGERR_SST,&
...
REAL(R8) :: ZBGETAERR,ZBGSSTERR,ZBGSSSERR,ZBGSICERR,ZBGSITERR,BGERR
REAL(R8) :: ZTOTVAR
REAL(R8) :: ZOMGP2
REAL(R8) :: ZRATIO
REAL(R8) :: ZALFA_SLA,ZALFA_INS,ZALFA_SST,ZALFA_SSS,ZALFA_SIC,ZALFA_SIT
INTEGER (I4) :: JOBS,KREJ(6),KNUM(6),I,J,D,I2,KP
...
IF(LLBGQC_SIC .AND. SIC%NO .GT. 0) THEN
...
LOOPSIC : DO JOBS=1,SIC%NO
     ...
     ZTOTVAR = SIC%BGERR(JOBS)*SIC%BGERR(JOBS) + SIC%ERR(JOBS)*SIC%ERR(JOBS)
...
IF(LLBGQC_SIT .AND. SIT%NO .GT. 0) THEN
...
LOOPSIT : DO JOBS=1,SIT%NO
     ...
     ZTOTVAR = SIT%BGERR(JOBS)*SIT%BGERR(JOBS) + SIT%ERR(JOBS)*SIT%ERR(JOBS)
