...
PUBLIC
   ...
   TYPE GRID_T
        ...
        INTEGER(I4)              ::  TOTAL_IM      ! TOTAL NO. POINTS IN X DIRECTION
...
!    IS RETAINED THROUGH PP KEY
        ...
        REAL(R8),    POINTER     ::  Q2M(:,:)    ! Q2M INCREMENT
        REAL(R8),    POINTER     ::  SIC(:,:)    ! SIC INCREMENT
        REAL(R8),    POINTER     ::  SIT(:,:)    ! SIT INCREMENT
        ...
        REAL(R8),    POINTER     ::  SIC_AD(:,:)    ! SIC INCREMENT towrds control space
        REAL(R8),    POINTER     ::  SIT_AD(:,:)    ! SIT INCREMENT towrds control space
        REAL(R8),    POINTER     ::  SIC_PHYS_AD(:,:)    ! SIC INCREMENT PHYSICAL SPACE (ONLY TEMPORARY)
        REAL(R8),    POINTER     ::  SIT_PHYS_AD(:,:)    ! SIT INCREMENT PHYSICAL SPACE (ONLY TEMPORARY)
        ...
        REAL(R8),    DYNMEM     ::  SICB(:,:,:)   ! SIC BACKGROUND
        REAL(R8),    DYNMEM     ::  SITB(:,:,:)   ! SIT BACKGROUND
        REAL(R8),    DYNMEM     ::  TRA_SICB(:,:,:)   ! SI TRANSF  BACKGROUND
        REAL(R8),    DYNMEM     ::  TRA_SITB(:,:,:)   ! SIT TRANSF  BACKGROUND
