...
IF (DRV%ICEOP(DRV%KTR) .EQ. 1)  THEN
   ...
   ZTEMP2=SIC_COEFF_TLAD
   DEALLOCATE(SIC_COEFF_TLAD)
   ALLOCATE(SIC_COEFF_TLAD(OLD_IM,GRD%JM)) 
   CALL DEWRAP(ZTEMP2,SIC_COEFF_TLAD)

   ZTEMP2=SIT_COEFF_TLAD
   DEALLOCATE(SIT_COEFF_TLAD)
   ALLOCATE(SIT_COEFF_TLAD(OLD_IM,GRD%JM))
   CALL DEWRAP(ZTEMP2,SIT_COEFF_TLAD)
   
   ZTEMP2=GRD%SIC_PHYS_AD
   DEALLOCATE(GRD%SIC_PHYS_AD)
   ALLOCATE(GRD%SIC_PHYS_AD(OLD_IM,GRD%JM))
   CALL DEWRAP(ZTEMP2,GRD%SIC_PHYS_AD)
   
   ZTEMP2=GRD%SIT_PHYS_AD
   DEALLOCATE(GRD%SIT_PHYS_AD)
   ALLOCATE(GRD%SIT_PHYS_AD(OLD_IM,GRD%JM))
   ...
   ! SIC OBSERVATIONS
      ...
      DO I=1,SIC%NO
       ...
       IF(SIC%FLC(I).EQ.1)THEN
         ...
         IF(ANY(SIC%IB(I,:).EQ.NEW_IM)) SIC%FLC(I)=0
      ...
      ! SIT OBSERVATIONS
         ...
         DO I=1,SIT%NO
          ...
          IF(SIT%FLC(I).EQ.1)THEN
            ...
            IF(ANY(SIT%IB(I,:).EQ.NEW_IM)) SIT%FLC(I)=0
