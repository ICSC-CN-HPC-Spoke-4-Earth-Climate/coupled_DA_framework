SUBROUTINE FINDFGTIMES_TL(CF,NTIMES,FGY,FGM,FGD,FGH,MT,RT)
...
WRITE(IOUNLOG,*)
WRITE(IOUNLOG,*) ' /// READING FG TIMESTEPS FROM FILE ',TRIM(CF)

STAT = NF90_OPEN(TRIM(CF), NF90_NOWRITE, NCID)
