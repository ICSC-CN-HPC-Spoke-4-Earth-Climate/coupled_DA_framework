...
INTEGER(I4) :: KPRC, KDUPL, JOBS,JPROF,JPROF2, KPIND, KPIND2,UPPROF,K,JT
  ...
  WRITE(IOUNOUT,*) ' READING IN SST DRIFTERS OBSERVATIONS'
  ...
  ENDIF
   ...
   WRITE(IOUNLOG,*) 'READING DRIFTER SST FILE'
  ...
  !... LOOP OVER EXISTING INS FILES
   DO WHILE(LPROCEED)
      WRITE(CFILE,'(A,I2.2)' ) 'DRIFTSST_',IFILE
      ...
      IF(LPROCEED) THEN
          ...
          CALL READDRIFTERFILE(CFILE,IOUNLOG,NMAX,&
   ...
   !... STORE OBS
          ...
          IF(NOBS.GT.0) THEN
            ...
            & CALL ABOR1('READ_DRIFTSST : NMAX MUST BE INCREASED')
      ...
      ELSE
          ...
          IF(IFILE.EQ.1) &
          & WRITE(IOUNERR,*) '*** WARNING : NO DRIFTER SST INSITU FILE'
 ...
 INS%DSRC(LOCAL_START:INS%NO) = 'DRF'

 WRITE(IOUNLOG,*)
 WRITE(IOUNLOG,*) ' TOTAL SST DRIFTER OBS : ',INS%NO-LOCAL_START+1
 WRITE(IOUNLOG,*)

END SUBROUTINE READ_DRIFTSST
