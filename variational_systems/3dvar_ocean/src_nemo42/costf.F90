...
!-----------------------------------------------------------------------
 ...
 REAL   (R8) :: JO_SLA, JO_INS, JO_SST, JO_SSS, JO_OTH, ZA1
 REAL   (R8) :: JO_TOA, ZCHC
 ...
 LL_DBG = ( LL_WEAKLY .OR. LL_ALPHA_CTL .OR. LL_DEBUGTMP)
 LLINCRBYITER = LL_DBG
...
! CALCULATE COST
  ...
  CTL%F_O = JO_SLA + JO_INS + JO_SST + JO_SSS
...
! -------------------------------------------------------
  ...
  IF( LL_WEAKLY .AND. LL_DEBUG_WEAKLY ) CALL PRINT_MODERR(CTL%KITER)
   ...
   & CTL%F_C, JO_SLA,JO_INS,JO_SST,JO_SSS,CTL%F_M,CTL%F_E,CTL%F_H,CTL%F_A,CTL%F_3
   CALL FLUSH(IOUNLOG)
   CALL FLUSH(IOUNCOST)
