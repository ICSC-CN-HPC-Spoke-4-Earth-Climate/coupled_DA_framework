...
!-----------------------------------------------------------------------
  ...
  NAMELIST /OBSLST/ OBS_SLA, OBS_ARG, OBS_XBT, OBS_GLD, OBS_VEL, OBS_TRJ,&
                    OBS_SST,OBS_AIR,OBS_AMSRE_SST,OBS_MWOI_SST,OBS_SSS,&
                    OBS_AQUAR_SSS,OBS_SMOS_SSS,OBS_AMSRE_SWATH_SST,&
                    OBS_TMI_SWATH_SST,OBS_AMSR2_SST,OBS_METOP_AVHRR_SST,OBS_NOAA_OI_SST,&
                    OBS_COPERN_L3S,OBS_COPERN_L3, OBS_SACD_SSS,&
                    LL_TQ2_ASSIM,LL_PROJDOWN,LL_ICE_ASSIM,LL_CERES,&
                    PRINT_NIGHT_OBSERVATION_ONLY,LL_NIGHT_ONLY_AMSR2_AVHHR
  NAMELIST /GRDLST/ NTR, GRID, RATIO, MASK, BARMD, DIVDA, DIVDI, CGRID, LL_ADJETAB, BALMD, BA2MD
  ...
  NAMELIST /SLALST/ SLA_DEP,SLA_USES,LCORRSSH,CSLA_FMT,CSLA_OPT,&
                    ...
                    SLA_REPERR_INFLAT,TOTAL_INFLAT_SLA,LL_SLABCORR,NN_SLABC_BY,&
  ...
  NAMELIST /INSLST/ CINS_FMT,ZMAXDEP,INS_LQC_POS, INS_LQC_TIME,INS_LQC_SAL, &
            ...
            NAMELIST /THINLST/ LTHIN_SLA,LTHIN_INS,LTHIN_SST,LTHIN_SSS,&
                    ...
                    RTHIND_SSS_X,RTHIND_SSS_Y, LL_SAVETHINOUTSLA
  NAMELIST /BGQCLST/ LLBGQC_SLA,LLBGQC_INS,LLBGQC_SST,LLBGQC_SSS,LLFORMBGE,&
                    LLUSEBGERR,RALFA_SLA, RALFA_INS, RALFA_SST, RALFA_SSS,&
                    RBGERR_SSH, RBGERR_SAL, RBGERR_TEM, RBGERR_SST, RBGERR_SSS,&
                    LL_READ_BGE
  ...
  NAMELIST /HYBLST/ LL_HYBRID,ZALPHA,NN_ALPHA_CTL,NEOF,NREGS,NKMT,LL_ALPHA_ONLINE,&
                    ...
                    LL_EOFS3D, NN_EOFS3D, AEO, LL_DIAHYBRID, LL_HYBRID_CR,LL_CORRAD_2D_HYB
...
!... DEFAULT VALUES
  ...
  IF( NSUBDOMAINS .LT. 0 ) THEN
      NSUBDOMAINS = 0
  ELSE
      IF( LMPION ) NSUBDOMAINS = MP_SD(MYPROC) +1
  ENDIF
...
! ---
  ...
  ROS%NEOF = NEOF
  ROS%NREG = NREGS
  IF (LL_SSH .AND. .NOT. LL_SSH_UNBALANCED) THEN
      ROS%KMT  = NKMT +1
  ELSE
      ROS%KMT  = NKMT
  ENDIF
...
! ---
  ...
  WRITE(IOUNLOG,*) ' INFLATION FOR SLA REP. ERROR : SLA_TOTAL_INFLAT =',TOTAL_INFLAT_SLA
...
! ---
  ...
  WRITE(IOUNLOG,*) ' US ARGO REMOVED =',LLUSQC
...
! ---
  ...
  WRITE(IOUNLOG,*) ' 2D FIELD FOR CORR LENGTH SCALE HYBRID LL_CORRAD_2D_HYB = ',LL_CORRAD_2D_HYB
